...
# Активируем использование реального TTS
ENV REAL_TTS_AVAILABLE=1
...
# Установка gTTS для синтеза речи
...
# Создаем улучшенную имплементацию класса TTS для случаев, когда реальный TTS не установлен
